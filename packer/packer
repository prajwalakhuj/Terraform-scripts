...
# Installing cloudwatch-agent and configure using ssm
...
sudo /opt/aws/amazon-cloudwatch-agent/bin/amazon-cloudwatch-agent-ctl -a fetch-config -m ec2 -c ssm:prajwal_cw_nodejs_config -s
